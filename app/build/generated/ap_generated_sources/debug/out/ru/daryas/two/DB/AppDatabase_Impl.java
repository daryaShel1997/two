  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Employee` (`id` INTEGER NOT NULL, `name` TEXT, `salary` INTEGER NOT NULL, `img` BLOB, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '27edabdca6ab22aeba3814ab3fa2bab0')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsEmployee.put("img", new TableInfo.Column("img", "BLOB", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoEmployee.equals(_existingEmployee)) {
          return new RoomOpenHelper.ValidationResult(false, "Employee(ru.daryas.two.DB.Employee).\n"
                  + " Expected:\n" + _infoEmployee + "\n"
                  + " Found:\n" + _existingEmployee);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "27edabdca6ab22aeba3814ab3fa2bab0", "ccc32c69de8fa886d6c464349c48f0c4");
